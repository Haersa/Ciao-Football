...
$pageTitle = "Replica Kits"; // This will be used in the title tag
$pageDescription = "Ciao Football's Retro Kit's page. View our premium quality replica kits"; // This is used as the page desciption meta tag
$pageKeywords = "Ciao, Football, Ciao Football, Soccer, replica, shirt, football shirts, equipment, store, premium, replicakits, kits, retro, kits page"; // This is used as the keywords meta tag
