...
$pageTitle = "Equipment"; // This will be used in the title tag
$pageDescription = "Ciao Football's Equipment Page. View our top quality football equipment."; // This is used as the page desciption meta tag
$pageKeywords = "Ciao, Football, Ciao Football, Soccer, replica, shirt, football shirts, equipment, store, premium, equipment page"; // This is used as the keywords meta tag
...
<main>
  ...
  <section class="product-grid"><!-- product grid section -->
    ...
    $stmt = $conn->prepare("SELECT * FROM equipment WHERE sale = ? AND quantity > 0");
